...
values."
  (setq-default
   ...
   ;; Lazy instruallation of layers (i.e. layers are installed only when a file
   ...
   dotspacemacs-additional-packages '(rainbow-delimiters)
